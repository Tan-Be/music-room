...
import { History, Music, TrendingUp, Clock, Users, Calendar } from 'lucide-react'
...
export default function HistoryPage() {
  ...
  const calculateAnalytics = (rooms: any[], tracks: any[]) => {
    ...
    const totalTime = tracks.reduce((sum, t) => sum + (t.track?.duration || 0), 0) / 60
    ...
    const daysActive = new Set(tracks.map(t => 
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            <Card className="p-6">
              ...
              <p className="text-2xl font-bold mt-2">
                {Math.floor(analytics.totalTime / 60)}ч {analytics.totalTime % 60}м
              </p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-xl font-bold mt-2">{analytics.mostActiveDay}</p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-2xl font-bold mt-2">{analytics.averageTracksPerDay}</p>
            </Card>
            ...
            <Card className="p-6">
              ...
              <p className="text-xl font-bold mt-2">{analytics.favoriteGenre}</p>
            </Card>
          </div>
        </TabsContent>
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        ...
                        <Badge variant={item.room.is_public ? 'default' : 'secondary'}>
