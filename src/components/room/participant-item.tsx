...
function arePropsEqual(
  prevProps: ParticipantItemProps,
  nextProps: ParticipantItemProps
) {
  return (
...
ParticipantItemComponent.displayName = 'ParticipantItem'

export { ParticipantItemComponent as ParticipantItem }
